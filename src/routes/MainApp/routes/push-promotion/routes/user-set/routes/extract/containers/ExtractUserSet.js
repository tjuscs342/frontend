...
const menuItems = [
  {
    ...
    key: 'basic',
    name: '基础属性',
    link: '/push-promotion/user-set/extract/basic'
  }, {
    key: 'region',
    name: '地域属性',
    link: '/push-promotion/user-set/extract/region'
  }, {
    key: 'bound',
    name: '绑定行为',
    link: '/push-promotion/user-set/extract/bound'
  }, {
    key: 'device',
    name: '设备属性',
    link: '/push-promotion/user-set/extract/device'
  }, {
    key: 'interest',
    name: '兴趣属性',
    link: '/push-promotion/user-set/extract/interest'
  }, {
    key: 'purchase',
    name: '购买属性',
    link: '/push-promotion/user-set/extract/purchase'
  }, {
    key: 'keyword',
    name: '关键词搜索',
    link: '/push-promotion/user-set/extract/keyword'
  }
]
...
function mapState(state) {
  return {
    state: state.pushPromotion.userSet.extract
  }
}
