...
class details extends Component {
  render() {
    return (
      <div style={{ height: '100%', overflow: 'auto', padding: 10, position: 'relative' }}>
        <div
          style={{
            position: 'fixed',
            height: 50,
          ...
          >
          <div className="divMiddle textCenter">
            {'< 返回'}
          </div>
        </div>
        <h2 style={{ color: 'black', textAlign: 'center' }}>考勤管理规定</h2>
        <h3 style={{ color: 'black', marginTop: 20, marginBottom: 10 }}>一． 目的</h3>
        <p>为规范公司考勤制度，加强公司对假期的管理，特制定《考勤管理规定》。</p>
        <h3 style={{ color: 'black', marginTop: 20, marginBottom: 10 }}>二． 适用范围</h3>
        <p>我司全体正式员工（多看、我司网服务部及物流部的具体考勤操作以团队内部流程为准）</p>
        <p>本考勤制度自 2014 年 1 月 1 日起执行</p>
        <h3 style={{ color: 'black', marginTop: 20, marginBottom: 10 }}>三． 假期规定</h3>
        <h4 style={{ marginTop: 5, marginBottom: 5 }}>1. 请假规定</h4>
        <p>1.1 请假方式：员工请假须提前在我司 HR 管理平台（以下简称“系统”）中提起申请，待相应主管批准后方可休假。因急事无法办理请假手续者，当天上午须以电话/短信向直接主管和人力资源部备案，假期结束的第一个工作日内须补上假期申请，否则按照旷工处理。请连续超过 5 个工作日的假期时，应提前至少一周申请。</p>
        ...
        <h4 style={{ marginTop: 5, marginBottom: 5 }}>2. 假期类别</h4>
        <h5 style={{ color: 'black' }}>2.1 带薪年假</h5>
        ...
        <h5 style={{ color: 'black' }}>2.2 病假</h5>
        ...
        <h5 style={{ color: 'black' }}>2.5 丧假及路途假</h5>
        ...
        <h5 style={{ color: 'black' }}>2.8 产假</h5>
        ...
        <h5 style={{ color: 'black' }}>2.12公共假日</h5>
        <p>元旦( 1 天 )、春节( 3 天 )、清明节（ 1 天 ）、国际劳动节（ 1 天 )、端午节（ 1 天 ）、中秋节（ 1 天 ）、国庆节（ 3 天 )。</p>
        <h3 style={{ color: 'black', marginTop: 20, marginBottom: 10 }}>四．补充定义</h3>
        <h4 style={{ marginTop: 5, marginBottom: 5 }}>旷工 - 符合以下任一条件者视为旷工：</h4>
        <p>1. 未按公司规定履行请假手续者；</p>
        <p>2. 假满不到职者；</p>
        ...
        <h4 style={{ marginTop: 5, marginBottom: 5 }}>实习生假期 - 实习生不论因各种缘由请假，均视为事假，扣除当天实习补助和其他补助。</h4>
