...
//   return (
//     fetch(`${url}/${location.search}`, config)
//       .then(json => json.json())
//       .then(response => {
//         if (response.status === 'NEED_LOGIN') {
//           const loginURL = `http://permission.d.xiaomi.net/login?referer=${location.href}`
//           // const loginURL = 'http://permission.d.xiaomi.net/login?referer=http://god.d.pt.xiaomi.com​:6888'
//           if (!location.search) {
